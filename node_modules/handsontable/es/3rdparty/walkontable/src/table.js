  ...
  _createClass(Table, [{
    ...
    value: function draw(fastDraw) {
      ...
      if (runFastDraw) {
        ...
        if (Overlay.isOverlayTypeOf(cloneOverlay, Overlay.CLONE_DEBUG) || Overlay.isOverlayTypeOf(cloneOverlay, Overlay.CLONE_TOP) || Overlay.isOverlayTypeOf(cloneOverlay, Overlay.CLONE_TOP_LEFT_CORNER)) {
          startRow = 0;
        ...
        if (Overlay.isOverlayTypeOf(cloneOverlay, Overlay.CLONE_DEBUG) || Overlay.isOverlayTypeOf(cloneOverlay, Overlay.CLONE_LEFT) || Overlay.isOverlayTypeOf(cloneOverlay, Overlay.CLONE_TOP_LEFT_CORNER) || Overlay.isOverlayTypeOf(cloneOverlay, Overlay.CLONE_BOTTOM_LEFT_CORNER)) {
          startColumn = 0;
        } else {
    ...
    value: function getCoords(TD) {
      ...
      if (overlayContainsElement(Overlay.CLONE_TOP_LEFT_CORNER, cellElement) || overlayContainsElement(Overlay.CLONE_LEFT, cellElement) || overlayContainsElement(Overlay.CLONE_BOTTOM_LEFT_CORNER, cellElement) || overlayContainsElement(Overlay.CLONE_BOTTOM, cellElement)) {
    ...
    value: function getRenderedColumnsCount() {
      ...
      } else if (wot.isOverlayName(Overlay.CLONE_LEFT) || wot.isOverlayName(Overlay.CLONE_TOP_LEFT_CORNER) || wot.isOverlayName(Overlay.CLONE_BOTTOM_LEFT_CORNER)) {
    ...
    value: function getRenderedRowsCount() {
      ...
      if (wot.isOverlayName(Overlay.CLONE_DEBUG)) {
        rowsCount = totalRows;
      } else if (wot.isOverlayName(Overlay.CLONE_TOP) || wot.isOverlayName(Overlay.CLONE_TOP_LEFT_CORNER)) {
        rowsCount = Math.min(wot.getSetting('fixedRowsTop'), totalRows);
      } else if (wot.isOverlayName(Overlay.CLONE_BOTTOM) || wot.isOverlayName(Overlay.CLONE_BOTTOM_LEFT_CORNER)) {
